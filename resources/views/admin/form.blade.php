    ...
    <body>
        ...
        <div id="page-container" class="fade page-container page-header-fixed page-sidebar-fixed page-with-two-sidebar page-with-footer">
            ...
            <div id="content" class="content">
                ...
                <h1 class="page-header">Manage Album</h1>
                    ...
                    <div class="panel-body">
                        ...
                        <form role="form" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">          
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="field-1"> Album Name <span class="required">*</span></label>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="field-1"> Order <span class="required">*</span></label>
